						...
						<div class="b-dropdown-block">
							...
							<ul class="list-unstyled">
								...
								<li>
									<!-- Item image -->
									<div class="cart-img">
									<a href="#"><img src="{{asset('brave/img/ecommerce/view-cart/1.png')}}" alt="" class="img-responsive" /></a>
									</div>
								...
								<li>
									<div class="cart-img">
									<a href="#"><img src="{{asset('brave/img/ecommerce/view-cart/2.png')}}" alt="" class="img-responsive" /></a>
									</div>
									<div class="cart-title">
										<h5><a href="#">Samsamgun galaxy some thing about.</a></h5>
										<span class="label label-color label-sm">$1,900</span>
